...
#define TIM3_CCR2 (*((volatile unsigned long *) 0x40000438))   //Timer 3 Capture/Compare Reg

#define TIM4_CR1  (*((volatile unsigned long *) 0x40000800))   //Timer 3 Control Reg 1
#define TIM4_CR2  (*((volatile unsigned long *) 0x40000804))   //Timer 3 Control Reg 2
#define TIM4_SR   (*((volatile unsigned long *) 0x40000810))   //Timer 3 Status Reg
#define TIM4_DIER (*((volatile unsigned long *) 0x4000080C))   //Timer 3 Interrupt Enable
#define TIM4_EGR  (*((volatile unsigned long *) 0x40000814))   //Timer 3 Event Generation Reg
#define TIM4_CCMR1 (*((volatile unsigned long *) 0x40000818))   //Timer 3 Capture/Compare Mode
#define TIM4_CCMR2 (*((volatile unsigned long *) 0x4000081C))   //Timer 3 Capture/Compare Mode
#define TIM4_CCER (*((volatile unsigned long *) 0x40000820))   //Timer 3 Compare/Capture Reg
#define TIM4_CNT  (*((volatile unsigned long *) 0x40000824))   //Timer 3 Count Reg
#define TIM4_PSC  (*((volatile unsigned long *) 0x40000828))   //Timer 3 Prescale Reg
#define TIM4_ARR  (*((volatile unsigned long *) 0x4000082C))   //Timer 3 Auto-Reload Reg
#define TIM4_CCR1 (*((volatile unsigned long *) 0x40000834))   //Timer 3 Capture/Compare Reg
#define TIM4_CCR2 (*((volatile unsigned long *) 0x40000838))   //Timer 3 Capture/Compare Reg
#define TIM4_CCR3 (*((volatile unsigned long *) 0x4000083C))   //Timer 3 Capture/Compare Reg
#define TIM4_CCR4 (*((volatile unsigned long *) 0x40000840))   //Timer 3 Capture/Compare Reg
...
#define SYSCFG_EXTICR1 (*((volatile unsigned long *) 0x40013808)) //EXTI Config Reg
#define SYSCFG_EXTICR2 (*((volatile unsigned long *) 0x4001380C)) //EXTI Config Reg
#define SYSCFG_EXTICR3 (*((volatile unsigned long *) 0x40013810)) //EXTI Config Reg
#define SYSCFG_EXTICR4 (*((volatile unsigned long *) 0x40013814)) //EXTI Config Reg
#define EXTI_IMR (*((volatile unsigned long *) 0x40013C00)) //EXTI Config Reg
#define EXTI_EMR (*((volatile unsigned long *) 0x40013C04)) //EXTI Config Reg
#define EXTI_RTSR (*((volatile unsigned long *) 0x40013C08)) //EXTI Config Reg
#define EXTI_FTSR (*((volatile unsigned long *) 0x40013C0C)) //EXTI Config Reg
#define EXTI_SWIER (*((volatile unsigned long *) 0x40013C10)) //EXTI Config Reg
#define EXTI_PR (*((volatile unsigned long *) 0x40013C14)) //EXTI Config Reg
	
#define RNG_CR (*((volatile unsigned long *) 0x50060800)) // RNG Control Reg
#define RNG_SR (*((volatile unsigned long *) 0x50060804)) // RNG Control Reg
#define RNG_DR (*((volatile unsigned long *) 0x50060808)) // RNG Control Reg
