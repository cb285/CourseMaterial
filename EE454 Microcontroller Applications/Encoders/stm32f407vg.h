...
#define TIM3_CCR1 (*((volatile unsigned long *) 0x40000434))   //Timer 3 Capture/Compare Reg 1
//Timer 4 addresses
#define TIM4_CR1  (*((volatile unsigned long *) 0x40000800))   //Timer 4 Control Reg 1
#define TIM4_CR2  (*((volatile unsigned long *) 0x40000804))   //Timer 4 Control Reg 2
#define TIM4_SR   (*((volatile unsigned long *) 0x40000810))   //Timer 4 Status Reg
#define TIM4_DIER (*((volatile unsigned long *) 0x4000080C))   //Timer 4 Interrupt Enable
#define TIM4_EGR  (*((volatile unsigned long *) 0x40000814))   //Timer 4 Event Generation Reg
#define TIM4_CCMR1 (*((volatile unsigned long *) 0x40000818))   //Timer 4 Capture/Compare Mode Reg 1
#define TIM4_CCMR2 (*((volatile unsigned long *) 0x4000081C))   //Timer 4 Capture/Compare Mode Reg 2
#define TIM4_CCER (*((volatile unsigned long *) 0x40000820))   //Timer 4 Compare/Capture Reg
#define TIM4_CNT  (*((volatile unsigned long *) 0x40000824))   //Timer 4 Count Reg
#define TIM4_PSC  (*((volatile unsigned long *) 0x40000828))   //Timer 4 Prescale Reg
#define TIM4_ARR  (*((volatile unsigned long *) 0x4000082C))   //Timer 4 Auto-Reload Reg
#define TIM4_CCR1 (*((volatile unsigned long *) 0x40000834))   //Timer 4 Capture/Compare Reg 1
#define TIM4_CCR2 (*((volatile unsigned long *) 0x40000838))   //Timer 4 Capture/Compare Reg 2
#define TIM4_CCR3 (*((volatile unsigned long *) 0x4000083C))   //Timer 4 Capture/Compare Reg 3
#define TIM4_CCR4 (*((volatile unsigned long *) 0x40000840))   //Timer 4 Capture/Compare Reg 4
//Timer 6 addresses
...
#define EXTI_EMR 		(*((volatile unsigned long *) 0x40013C04))
#define EXTI_RTSR 	(*((volatile unsigned long *) 0x40013C08))
#define EXTI_FTSR 	(*((volatile unsigned long *) 0x40013C0C))
#define EXTI_SWIER 	(*((volatile unsigned long *) 0x40013C10))
